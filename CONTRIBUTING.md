# Contributing to ansible-synology-dsm

Thank you for your interest in contributing to **ansible-synology-dsm**!
...
```bash
git clone https://github.com/stevefulme1/ansible-synology-dsm.git
cd ansible-synology-dsm
```
